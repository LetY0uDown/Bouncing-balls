...
pub struct CircleMassesSim {
	pub circles: Vec<Circle>,
	pub clamp_velocity: bool,
	pub display_collision: bool
}

impl WindowHandler for CircleMassesSim
{
	fn on_draw(&mut self, helper: &mut WindowHelper, graphics: &mut Graphics2D)
	{
		...
		for circle in &mut self.circles {
			...
			// circle.velocity = vec_lerp(circle.velocity, VEC_ZERO, 0.01 * DELTA_TIME);
...
impl CircleMassesSim {
	pub fn init(circles_count: usize, orig_color_func: fn() -> Color, distribution: &Curve) -> CircleMassesSim {
